...
let orderTotals = orders.map(function(order, i){
...
// Each item in array is passed in with the property of the function

let bobsTotal = purchases.reduce(function(bobsTotal, purchase){
  // for (let i = 0; i < purchases.length; i++) {
  //   if (owner === bob)
  // }
  if (purchase.owner === 'Bob'){
    return bobsTotal + purchase.price;
  } else {
    return bobsTotal;
  }
}, 0)
